...
It should be run by an MCP client like Claude Desktop.
    ...
    async generateImage(args) {
        const { prompt, output_path = "generated_image.png", safety_level = "BLOCK_MEDIUM_AND_ABOVE", person_generation = "DONT_ALLOW" } = args;
        ...
        try {
            const response = await axios.post(GOOGLE_IMAGINE_API_URL, requestBody, {
                headers: {
